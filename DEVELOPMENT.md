...
```bash
git remote add encore encore://cardfix-app-migration-2vn2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/cardfix-app-migration-2vn2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/cardfix-app-migration-2vn2/settings/integrations/github)
